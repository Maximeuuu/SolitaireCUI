// -*- coding: utf-8 -*-
/**
 * Description : Cette classe représente une Pile de carte.
 * Elle contient un tableau de carte fini et un indice de sommet.
 * Méthodes : constucteurs de création, constructeur de copie, accesseurs, modifieurs, retourner, mélanger, affichage
 */
...
public class Pile
{
	...
	{
		return this.sommet == this.tasCarte.length-1;
	}
